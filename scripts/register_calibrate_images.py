...
if __name__ == '__main__':
    ...
    if args.register_images:
        ...
        config, sky_pos, src = lbcred.register_images(tmp_path=args.tmp_path, bandpass='R', ref_cat=args.ref_cat, index_path=args.index_path, make_plots=args.make_plots, config_fn=args.config)

        # Register b-band images
        config, sky_pos, src = lbcred.register_images(tmp_path=args.tmp_path, bandpass='B', ref_cat=args.ref_cat, index_path=args.index_path, make_plots=args.make_plots, config_fn=args.config)
